...
const About = forwardRef(({ isDarkMode }, ref) => {
  return (
    <section
      ref={ref}
      id="about"
        ...
        <div className="shadow-2xl relative w-[110%] h-[60%] md:h-[60%] bg-[--about-color] top-[20%] md:top-[14%] left-[-4%] transform rotate-3 flex items-center justify-center md:justify-between px-6 md:px-16">
          <div className="relative z-10 mx-auto w-full max-w-6xl flex flex-col md:flex-row items-center justify-between gap-8 px-6">
            ...
            <div className=" text-xl max-w-lg md:ml-6 -rotate-3 font-semibold">
              <p>
                I'm a fullstack developer specialising in the MERN stack. Since
                the beginning of my journey, I've created bespoke digital
                solutions for both business and consumer use. I particularly
                enjoy integrating powerful backends with beautiful interfaces
                for data visualisation. In my free time I'm experimenting with
                artificial intelligence and brewing my own wine.
              </p>
